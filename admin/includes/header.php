                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                           ...
                           <!-- <li class="has-submenu">
                                <a href="#"><i class="zmdi zmdi-collection-text"></i> <span> Add Vehicle </span> </a>
                                <ul class="submenu megamenu">
                                    <li>
                                        <ul>
                                            <li><a href="add-brand.php">Add Brand</a></li>
                                            <li><a href="add-city.php">Add City</a></li>
                                            <li><a href="add-area.php">Add Area</a></li>
							...
							<li>
                                <a href="add-donors.php"><i class="zmdi zmdi-view-dashboard"></i> <span> Donors </span> </a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="zmdi zmdi-album"></i> <span> Manage Pages </span> </a>
                                <ul class="submenu">
                                    <li><a href="manage-donors.php">Manage Donors</a></li>
